...
<div class="card shadow-lg border-light">
    <div class="card-body">
        <ul class="nav nav-pills mb-3" id="myTab2" role="tablist">
            <li class="nav-item">
                <a class="nav-link" id="profile-tab2" href="<?= Url::to('/cms/default/user-profile') ?>" role="tab" aria-selected="false">
                    Profile
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" id="profile-tab2" href="<?= Url::to('/cms/default/change-password') ?>" role="tab" aria-selected="true">
                    Change Password
                </a>
            </li>
        </ul>
